...
SD Kanban 是一个基于 Spring Boot 3 + Vue 3 的敏捷看板应用，适用于项目负责人和小型交付团队。它包含 JWT 登录、项目、项目负责人、成员、迭代、自定义看板列、任务、项目看板与个人看板、仪表盘统计，以及 MySQL 数据持久化等功能。
...
测试会在 MySQL 中创建临时账号、项目、任务和评论记录，并在运行结束后删除这些记录。
